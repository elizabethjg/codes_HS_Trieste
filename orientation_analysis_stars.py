...
r1000 = np.ones(len(R200))*np.median(gral[4])
r500  = np.ones(len(R200))*np.median(gral[5])
r200  = np.ones(len(R200))*np.median(gral[6])
r1    = np.ones(len(R200))*np.median(0.1*R500)
r = np.vstack((r1,r1000,r500,r200)).T
rp = np.array((r.tolist())*3)
...
for i in range(len(R1)):
    j = np.argsort(lM)[i]
    plt.plot(np.log10(r[j]),S[j,2:],'C1',alpha=0.25+i*0.01)
plt.plot(np.log10(r[0]),np.median(S[:,2:],axis=0),'k')
plt.xlabel('$\log(R)$')
plt.ylabel('$S$')
plt.axis([np.log10(30),np.log10(R200.max()),0,1])
plt.xticks(np.log10(r[0]),['0.1R500','R1000','R500','R200'])
plt.savefig(path_plots+'S_R_scaled.png')
...
for i in range(len(R1)):
    j = np.argsort(lM)[i]
    plt.plot(np.log10(r[j]),T[j,2:],'C0',alpha=0.25+i*0.01)
plt.plot(np.log10(r[0]),np.median(T[:,2:],axis=0),'k')
plt.xlabel('$\log(R)$')
plt.ylabel('$T$')
plt.axis([np.log10(30),np.log10(R200.max()),0,1])
plt.xticks(np.log10(r[0]),['0.1R500','R1000','R500','R200'])
plt.savefig(path_plots+'T_R_scaled.png')
...
for i in range(len(R1)*3):
    j = np.argsort(lMp)[i]
    plt.plot(np.log10(rp[j]),q[j,2:],'C2',alpha=0.25+i*0.003)
plt.plot(np.log10(rp[0]),np.median(q[:,2:],axis=0),'k')
plt.xlabel('$\log(R)$')
plt.ylabel('$q$')
plt.axis([np.log10(30),np.log10(R200.max()),0,1])
plt.xticks(np.log10(r[0]),['0.1R500','R1000','R500','R200'])
plt.savefig(path_plots+'q_R_scaled.png')
...
for i in range(len(R1)):
    j = np.argsort(lM)[i]
    plt.plot(np.log10(r[j]),t3D[j,2:],'C3',alpha=0.25+i*0.01)
plt.plot(np.log10(r[0]),np.median(t3D[:,2:],axis=0),'k')
plt.xlabel('$\log(R)$')
plt.ylabel(r'$\theta$')
plt.axis([np.log10(30),np.log10(R200.max()),0,90])
plt.xticks(np.log10(r[0]),['0.1R500','R1000','R500','R200'])
plt.savefig(path_plots+'t3D_R_scaled.png')
...
for i in range(len(R1)*3):
    j = np.argsort(lMp)[i]
    plt.plot(np.log10(rp[j]),t2D[j,2:],'C4',alpha=0.25+i*0.003)
plt.plot(np.log10(rp[0]),np.median(t2D[:,2:],axis=0),'k')
plt.xlabel('$\log(R)$')
plt.ylabel(r'$\theta_{2D}$')
plt.axis([np.log10(30),np.log10(R200.max()),0,90])
plt.xticks(np.log10(r[0]),['0.1R500','R1000','R500','R200'])
plt.savefig(path_plots+'t2D_R_scaled.png')
...
plt.figure()
plt.plot(dm.S,s30.S,'b^',label='30 kpc',alpha=0.5)
plt.plot(dm.S,s50.S,'C3o',label='50 kpc')
plt.plot(dm.S,s1000.S,'C1v',label='0.1R500')
...
plt.figure()
plt.plot(dm.S,s1000.S,'b^',label='R1000',alpha=0.5)
plt.plot(dm.S,s500.S,'C3o',label='R500')
plt.plot(dm.S,s200.S,'C1v',label='R200')
plt.plot([0.3,0.85],[0.3,0.85],'C7--')
plt.legend()
plt.xlabel('$S_{DM}$')
plt.ylabel('$S_{*}$')
...
plt.figure()
plt.plot(dm.T,s30.T,'b^',label='30 kpc',alpha=0.5)
plt.plot(dm.T,s50.T,'C3o',label='50 kpc')
plt.plot(dm.T,s1000.T,'C1v',label='0.1R500')
plt.plot([0.3,0.85],[0.3,0.85],'C7--')
plt.legend()
plt.xlabel('$T_{DM}$')
plt.ylabel('$T_{*}$')
...
plt.figure()
plt.plot(dm.T,s1000.T,'b^',label='R1000',alpha=0.5)
plt.plot(dm.T,s500.T,'C3o',label='R500')
plt.plot(dm.T,s200.T,'C1v',label='R200')
plt.plot([0.3,0.85],[0.3,0.85],'C7--')
plt.legend()
plt.xlabel('$T_{DM}$')
plt.ylabel('$T_{*}$')
...
plt.figure()
plt.plot(dm.q,s30.q,'b^',label='30 kpc',alpha=0.5)
plt.plot(dm.q,s50.q,'C3o',label='50 kpc')
plt.plot(dm.q,s1000.q,'C1v',label='0.1R500')
plt.plot([0.3,0.85],[0.3,0.85],'C7--')
plt.legend()
plt.xlabel('$q_{DM}$')
plt.ylabel('$q_{*}$')
...
plt.figure()
plt.plot(dm.q,s1000.q,'b^',label='R1000',alpha=0.5)
plt.plot(dm.q,s500.q,'C3o',label='R500')
plt.plot(dm.q,s200.q,'C1v',label='R200')
plt.plot([0.3,0.85],[0.3,0.85],'C7--')
plt.legend()
plt.xlabel('$q_{DM}$')
plt.ylabel('$q_{*}$')
