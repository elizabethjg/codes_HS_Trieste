...
fM30   = 10**(C.lM30)/10**(C.lM200)
fM50   = 10**(C.lM50)/10**(C.lM200)
fM100  = 10**(C.lM100)/10**(C.lM200)
fM1000 = 10**(C.lM1000)/10**(C.lM200)
fM500  = 10**(C.lM500)/10**(C.lM200)
fM200  = 10**(C.lM200)/10**(C.lM200)

fM_r = np.vstack((fM30,fM50,fM100,fM1000,fM500,fM200)).T
...
# ax[0,0].axhline(1/3.,color='C7')
# ax[0,0].axhline(2/3.,color='C7')
# ax[0,1].axhline(1/3.,color='C7')
# ax[0,1].axhline(2/3.,color='C7')
# ax[0,2].axhline(1/3.,color='C7')
# ax[0,2].axhline(2/3.,color='C7')
...
cDMUM_gap = CorrelR(DarkMatter,DarkMatter,m = mmas*C.mn_gap, m2d = mlowp*C.mn2d_gap)
...
cDMUM_off = CorrelR(DarkMatter,DarkMatter,m = mmas*C.mn_off, m2d = mlowp*C.mn2d_off)
...
plotR_ind(C.Rs[mlow*C.mo_gap],cDMRL_gap.t3D_dm200,'C3','all',ax = ax[0,0],style='--')
plotR_ind(C.Rs[mmas*C.mo_gap],cDMRM_gap.t3D_dm200,'C3','all',ax = ax[0,0],style='-')
plotR_ind(C.Rs[mlow*C.mn_gap],cDMUL_gap.t3D_dm200,'C0','all',ax = ax[0,0],style='--')
plotR_ind(C.Rs[mmas*C.mn_gap],cDMUM_gap.t3D_dm200,'C0','all',ax = ax[0,0],style='-')                                                                     
plotR_ind(C.Rs[mlow*C.mo_off],cDMRL_off.t3D_dm200,'C3','all',ax = ax[0,1],style='--')
plotR_ind(C.Rs[mmas*C.mo_off],cDMRM_off.t3D_dm200,'C3','all',ax = ax[0,1],style='-')
plotR_ind(C.Rs[mlow*C.mn_off],cDMUL_off.t3D_dm200,'C0','all',ax = ax[0,1],style='--')
plotR_ind(C.Rs[mmas*C.mn_off],cDMUM_off.t3D_dm200,'C0','all',ax = ax[0,1],style='-')
plotR_ind(C.Rs[mlow*C.mo_dv] , cDMRL_dv.t3D_dm200,'C3','all',ax = ax[0,2],style='--')
plotR_ind(C.Rs[mmas*C.mo_dv] , cDMRM_dv.t3D_dm200,'C3','all',ax = ax[0,2],style='-')
plotR_ind(C.Rs[mlow*C.mn_dv] , cDMUL_dv.t3D_dm200,'C0','all',ax = ax[0,2],style='--')
plotR_ind(C.Rs[mmas*C.mn_dv] , cDMUM_dv.t3D_dm200,'C0','all',ax = ax[0,2],style='-')

plotR_ind(C.Rsp[mlowp*C.mo2d_gap],cDMRL_gap.t2D_dm200, 'C3','all',ax = ax[1,0],style='--')
plotR_ind(C.Rsp[mmasp*C.mo2d_gap],cDMRM_gap.t2D_dm200, 'C3','all',ax = ax[1,0],style='-')
plotR_ind(C.Rsp[mlowp*C.mn2d_gap],cDMUL_gap.t2D_dm200, 'C0','all',ax = ax[1,0],style='--')
plotR_ind(C.Rsp[mmasp*C.mn2d_gap],cDMUM_gap.t2D_dm200, 'C0','all',ax = ax[1,0],style='-')                                                                     
plotR_ind(C.Rsp[mlowp*C.mo2d_off],cDMRL_off.t2D_dm200, 'C3','all',ax = ax[1,1],style='--')
plotR_ind(C.Rsp[mmasp*C.mo2d_off],cDMRM_off.t2D_dm200, 'C3','all',ax = ax[1,1],style='-')
plotR_ind(C.Rsp[mlowp*C.mn2d_off],cDMUL_off.t2D_dm200, 'C0','all',ax = ax[1,1],style='--')
plotR_ind(C.Rsp[mmasp*C.mn2d_off],cDMUM_off.t2D_dm200, 'C0','all',ax = ax[1,1],style='-')
plotR_ind(C.Rsp[mlowp*C.mo2d_dv] , cDMRL_dv.t2D_dm200, 'C3','all',ax = ax[1,2],style='--')
plotR_ind(C.Rsp[mmasp*C.mo2d_dv] , cDMRM_dv.t2D_dm200, 'C3','all',ax = ax[1,2],style='-')
plotR_ind(C.Rsp[mlowp*C.mn2d_dv] , cDMUL_dv.t2D_dm200, 'C0','all',ax = ax[1,2],style='--')
plotR_ind(C.Rsp[mmasp*C.mn2d_dv] , cDMUM_dv.t2D_dm200, 'C0','all',ax = ax[1,2],style='-')

ax[0,0].set_xlim([0.012,1.01])
ax[0,0].set_xscale('log')

ax[1,0].set_xlabel('$R/R_{200}$')
ax[1,1].set_xlabel('$R/R_{200}$')
ax[1,2].set_xlabel('$R/R_{200}$')
